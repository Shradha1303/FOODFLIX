...
--
-- Host: 127.0.0.1    Database: food_details
-- ------------------------------------------------------
...
CREATE TABLE `allfood` (
  ...
  `offerprice` varchar(6) DEFAULT NULL,
...
INSERT INTO `allfood` VALUES (1,1,100,'The cuisine of the Indian state of Gujaratru','550','300','gj.png','VEG','Available'),(2,1,100,'Kahaman Dhokla','50','30','dhokla.jpg','VEG','Available');
...
-- Dump completed on 2023-05-27 20:09:15
